...
g_library_definition_c = LibraryDefinition(
    "c",
    (
        ("int", "fclose", "FILE*"),
...
g_library_definition_bcm_host = LibraryDefinition(
    "bcm_host",
    (
...
g_library_definition_egl = LibraryDefinition(
    "EGL",
    (
        (
            "EGLBoolean",
...
g_library_definition_gl = LibraryDefinition(
    PlatformVar("gl_library"),
    (
...
g_library_definition_glu = LibraryDefinition(
    "GLU",
    (
        (
            "GLint",
...
g_library_definition_freetype = LibraryDefinition(
    "freetype",
    (
...
g_library_definition_m = LibraryDefinition(
    "m",
    (
        ("double", "acos", "double"),
        ("float", "acosf", "float"),
...
g_library_definition_png = LibraryDefinition(
    "png",
    (
...
g_library_definition_sdl = LibraryDefinition(
    "SDL",
    (
...
g_library_definition_sdl3 = LibraryDefinition(
    "SDL3",
    (
...
g_library_definition_vulkan = LibraryDefinition(
    "Vulkan", (("VkResult", "vkDeviceWaitIdle", "VkDevice"),)
)

g_library_definition_sndfile = LibraryDefinition(
    "sndfile",
    (
