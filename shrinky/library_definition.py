...
from shrinky.symbol import Symbol
...
g_library_definition_bcm_host = LibraryDefinition("bcm_host", (
    ...
    ("DISPMANX_ELEMENT_HANDLE_T", "vc_dispmanx_element_add", "DISPMANX_UPDATE_HANDLE_T", "DISPMANX_DISPLAY_HANDLE_T", "int32_t", "const VC_RECT_T*",
        "DISPMANX_RESOURCE_HANDLE_T", "const VC_RECT_T*", "DISPMANX_PROTECTION_T", "VC_DISPMANX_ALPHA_T*", "DISPMANX_CLAMP_T*", "DISPMANX_TRANSFORM_T"),
...
g_library_definition_gl = LibraryDefinition(PlatformVar("gl_library"), (
    ...
    ("void", "glTexImage3D", "GLenum", "GLint", "GLint", "GLsizei",
    ...
    ("void", "glTexSubImage2D", "GLenum", "GLint", "GLint", "GLint",
